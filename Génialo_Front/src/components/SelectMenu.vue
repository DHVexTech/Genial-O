    ...
    <b-container>
        <b-row>
            ...
            <b-col>
                ...
                <p></p>
                <b-btn v-b-tooltip.hover.left="'Controlez le robot!'" variant="outline-success" v-on:click="Appear('boolManual')">Confirmer</b-btn>
                </b-jumbotron>
            </b-col>
            <b-col>
                <b-jumbotron header="Automatique" lead="Parametrer le mode automatique" >
                <p></p>
                <b-btn v-b-tooltip.hover.left="'Parametrez notre robot!'" variant="outline-success" v-on:click="Appear('boolAuto')">Confirmer</b-btn>
                </b-jumbotron>
            </b-col>
        </b-row>
    </b-container>
...
export default {
  ...
  methods:{
    ...
    Appear: function(field) {
      ...
      if(field == 'boolAuto') {
        this.SetBoolAuto();
        this.boolAuto = this.Auto();
      } else {
        this.SetBoolManual();
        this.boolManual = this.Manual();
      }
